...
We will have some hydras for many functions.
    ...
    :init (progn
            ...
            (setq org-capture-templates
                  '(("t" "Todo" entry (file+headline "~/Dropbox/org/index.org" "Tasks") "* TODO %?\n  %i\n  %a")
                    ("b" "Book" entry (file+headline "~/Dropbox/org/library.org" "Book") "* TODO %?")
...
Let's create an hydra at F1 that shows all the apps
...
(global-set-key (kbd "<f1>") 'applications-menu/body)
#+END_SRC
