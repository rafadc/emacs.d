...
Flyspell uses some homebrew binaries. We need to add /usr/local to the exectuables path in emacs.
...
Adding file types with no rb extension: rake files, puppet...

#+BEGIN_SRC emacs-lisp
(add-to-list 'auto-mode-alist
	     '("\\.\\(?:gemspec\\|irbrc\\|gemrc\\|rake\\|rb\\|ru\\|thor\\|pp\\)\\'" . ruby-mode))
