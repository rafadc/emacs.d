...
- Fira Code: I want to test something with programming ligatures
...
And the ligatures. If I'm not using fira code I need to remove this.
...
(use-package org
  ...
  :init (progn
          ...
          (setq org-capture-templates
                    '(("t" "Todo" entry (file+headline "~/org/index.org" "Tasks") "* TODO %?\n  %i\n  %a")
...
I am starting a Jekyll blog I can write from emacs. I'll be trying to have everything as close as possible.
